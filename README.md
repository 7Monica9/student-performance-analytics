...
⚠️ **A risk assessment table** that highlights students with declining performance  
🤖 **AI Pedagogical Insight** report generator (placeholder or Gemini API)
...
This project is designed as a **portfolio-ready PoC** to demonstrate:

- **Data-informed progress tracking**
- **Student performance analytics thinking**
